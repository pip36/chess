...
describe("Chess object", () => {
    ...
    describe("valid moves", () => {
        ...
        describe("castling kingside", () => {
            it("should be able to castle when valid", () => {
                var chess = Chess()
                chess.place('-','F1')
                chess.place('-','G1')
                expect(chess.validMoves('E1')).toEqual(['F1','G1'])
            })
            it("should result in castled position", () => {
                var chess = Chess()
                chess.place('-','F1')
                chess.place('-','G1')
                chess.move('E1', 'G1')
                expect(chess.getPiece('G1').type).toEqual('k')
                expect(chess.getPiece('F1').type).toEqual('r')
            })
            it("should not be able to castle over friendly pieces", () => {
                var chess = Chess()
                chess.place('-','G1')
                expect(chess.validMoves('E1')).toEqual([])
            })
            it("should not be able castle to without a rook", () => {
                var chess = Chess()
                chess.place('-','F1')
                chess.place('-','G1')
                chess.place('-','H1')
                expect(chess.validMoves('E1')).toEqual(['F1'])
            })
            it("should not be able castle if in check", () => {
                var chess = Chess()
                chess.place('-','F1')
                chess.place('-','G1')
                chess.place('n', 'D3')
            ...
            it("should not be able castle if the path is under attack", () => {
                var chess = Chess()
                chess.place('-','F1')
                chess.place('-','G1')
                chess.place('-', 'F2')
            ...
            it("should not be able castle if the path is under attack 2", () => {
                var chess = Chess()
                chess.place('-','F1')
                chess.place('-','G1')
                chess.place('-', 'G2')
            ...
            it("should not be able castle if king has already moved", () => {
                var chess = Chess()
                chess.place('-','F1')
                chess.place('-','G1')
                chess.move('E1', 'F1')
            ...
            it("should not be able castle if rook has already moved", () => {
                var chess = Chess()
                chess.place('-','F1')
                chess.place('-','G1')
                chess.move('H1', 'F1')
            ...
            it("black should be able to castle when valid", () => {
                var chess = Chess()
                chess.setPlayer('black')
                chess.place('-','F8')
                chess.place('-','G8')
                expect(chess.validMoves('E8')).toEqual(['F8','G8'])
            })
            it("should result in castled position black", () => {
                var chess = Chess()
                chess.setPlayer('black')
                chess.place('-','F8')
                chess.place('-','G8')
                chess.move('E8', 'G8')
                expect(chess.getPiece('G8').type).toEqual('k')
                expect(chess.getPiece('F8').type).toEqual('r')
            })
            it("should not be able to castle over friendly pieces black", () => {
                var chess = Chess()
                chess.setPlayer('black')
                chess.place('-','G8')
                expect(chess.validMoves('E8')).toEqual([])
            })
            it("should not be able castle to without a rook black", () => {
                var chess = Chess()
                chess.setPlayer('black')
                chess.place('-','F8')
                chess.place('-','G8')
                chess.place('-','H8')
                expect(chess.validMoves('E8')).toEqual(['F8'])
            })
            it("should not be able castle if in check black", () => {
                var chess = Chess()
                chess.setPlayer('black')
                chess.place('-','F8')
                chess.place('-','G8')
            ...
            it("should not be able castle if the path is under attack black", () => {
                var chess = Chess()
                chess.setPlayer('black')
                chess.place('-','F8')
                chess.place('-','G8')
            ...
            it("should not be able castle if the path is under attack 2 black", () => {
                var chess = Chess()
                chess.setPlayer('black')
                chess.place('-','F8')
                chess.place('-','G8')
            ...
            it("should not be able castle if king has already moved black", () => {
                var chess = Chess()
                chess.place('-','F8')
                chess.place('-','G8')
                chess.move('E2', 'E3')
            ...
            it("should not be able castle if rook has already moved black", () => {
                var chess = Chess()
                chess.place('-','F8')
                chess.place('-','G8')
                chess.move('E2', 'E3')
        ...
        describe("castling queenside", () => {
            it("should be able to castle when valid", () => {
                ...
                chess.place('-','C1')
                chess.place('-','B1')
                expect(chess.validMoves('E1').sort()).toEqual(['C1','D1'].sort())
            })
            it("should result in castled position", () => {
                var chess = Chess()
                chess.place('-','D1')
                ...
                chess.place('-','B1')
                chess.move('E1', 'C1')
                expect(chess.getPiece('C1').type).toEqual('k')
                expect(chess.getPiece('D1').type).toEqual('r')
            })
            it("should not be able to castle over friendly pieces", () => {
                var chess = Chess()
                chess.place('-','C1')
            ...
            it("should not be able castle to without a rook", () => {
                ...
                chess.place('-','B1')
                chess.place('-','A1')
                expect(chess.validMoves('E1')).toEqual(['D1'])
            })
            it("should not be able castle if in check", () => {
                var chess = Chess()
                chess.place('-','D1')
            ...
            it("should be able to castle when valid black", () => {
                var chess = Chess()
                chess.setPlayer('black')
                chess.place('-','D8')
                chess.place('-','C8')
                chess.place('-','B8')
                expect(chess.validMoves('E8').sort()).toEqual(['C8','D8'].sort())
            })
            it("should result in castled position black", () => {
                var chess = Chess()
                chess.setPlayer('black')
                ...
                chess.place('-','B8')
                chess.move('E8', 'C8')
                expect(chess.getPiece('C8').type).toEqual('k')
                expect(chess.getPiece('D8').type).toEqual('r')
            })
            it("should not be able to castle over friendly pieces black", () => {
                var chess = Chess()
                chess.setPlayer('black')
            ...
            it("should not be able castle to without a rook black", () => {
                ...
                chess.place('-','B8')
                chess.place('-','A8')
                expect(chess.validMoves('E8')).toEqual(['D8'])
            })
            it("should not be able castle if in check black", () => {
                var chess = Chess()
                chess.setPlayer('black')
